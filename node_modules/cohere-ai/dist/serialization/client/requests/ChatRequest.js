...
exports.ChatRequest = core.serialization.object({
    ...
    toolResults: core.serialization.property("tool_results", core.serialization
        .list(core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../..")))).ChatRequestToolResultsItem; })))
        .optional()),
});
